        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-2xl sm:px-10 border border-gray-100">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex justify-center items-center gap-3 py-3 px-4 border border-gray-300 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 hover:-translate-y-1 hover:scale-[1.02] hover:shadow-lg active:scale-95 active:translate-y-0 transition-all duration-200"
            >
            ...
            <button
              ...
              className="w-full flex justify-center items-center gap-3 py-3 px-4 border border-transparent rounded-xl shadow-sm bg-[#1877F2] text-sm font-medium text-white hover:bg-[#166FE5] hover:-translate-y-1 hover:scale-[1.02] hover:shadow-lg active:scale-95 active:translate-y-0 transition-all duration-200"
            >
          ...
          <form className="space-y-4 mt-6" onSubmit={handleCredentialsLogin}>
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className="w-full flex justify-center py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-bold text-white bg-dilim-portakal hover:bg-dilim-turuncu hover:-translate-y-1 hover:scale-[1.02] hover:shadow-lg active:scale-95 active:translate-y-0 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-dilim-portakal disabled:opacity-70 disabled:hover:translate-y-0 disabled:hover:shadow-sm disabled:hover:scale-100 transition-all duration-200"
              >
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <a 
                href="/kayit" 
                className="w-full flex justify-center py-3 px-4 border border-dilim-portakal rounded-xl shadow-sm text-sm font-bold text-dilim-portakal bg-white hover:bg-orange-50 hover:-translate-y-1 hover:scale-[1.02] hover:shadow-lg active:scale-95 active:translate-y-0 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-dilim-portakal transition-all duration-200"
              >
                Yeni hesap oluştur
              </a>
            </div>
