...
export default async function AboutPage() {
  ...
  const storyParagraphs = aboutData?.storyContent?.length > 0 
    ...
    : [
        { paragraph: "<strong>Dilim Pastaneleri</strong> 1977 yılında, İstanbul’un tarihi semtlerinden biri olan boğazın girişindeki Kuzguncuk semtinde, Hayri, Hüsnü ve Mehmet ŞAHİN kardeşlerin ortaklığıyla köklü bir lezzet yolculuğuna başlamıştır. İlk günden itibaren kaliteli ve doğal üretime odaklanarak ününü kısa sürede semtin dışına taşımıştır." },
        { paragraph: "İlerleyen yıllarda markanın vizyonunu tek başına üstlenen baş şef ve kurucumuz <strong>Mehmet ŞAHİN</strong>, 2000 yılında bu eşsiz lezzet mirasını yeni gelişmekte olan <strong>Kavacık</strong> semtine taşıyarak modern imalathanesiyle markayı daha da ileriye taşımıştır. Mehmet Şahin'in yenilikçi tarifleri ve ustalığı sayesinde Kavacık'ın vazgeçilmez lezzet durağı haline gelen markamız, prestijli bir konuma ulaşmıştır." },
        { paragraph: "Müşterilerimizin ve Mehmet Şahin'in sadık müdavimlerinin yoğun talebi üzerine Eğitim ve Araştırma Hastanesinin karşısına <strong>Ümraniye</strong> şubesi açılmış; burada 200 m²’lik modern, hijyenik imalathanemizle birlikte daha geniş bir kitleye ulaşılmıştır." },
        { paragraph: "Şu anda, İstanbul’un Anadolu yakasında <strong>Kavacık Merkez ve Ümraniye olmak üzere 2 şubemizle</strong> hizmet vermekteyiz. Kurucumuz Mehmet Şahin'in vizyonu doğrultusunda ISO ve HACCP kalite standartlarının uygulandığı, alanında uzman ustalarımızla birlikte yaş pasta, tatlı ve dondurma gibi birçok özel lezzeti en taze haliyle sunmanın haklı gururunu yaşıyoruz." }
      ]
